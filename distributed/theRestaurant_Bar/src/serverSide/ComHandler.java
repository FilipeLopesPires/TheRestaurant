...
/**
 *  Definition of the service provider agent thread (communication handler) for this solution of the Restaurant's Problem, implementing the client-server model 
