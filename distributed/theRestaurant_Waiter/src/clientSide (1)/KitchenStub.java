...
public class KitchenStub {
    ...
    */
    /**
     *  Used by Waiter (server solicitation) to notify the Chef once the Students have chosen their courses.
     */
    ...
    */
    /**
     *  Used by Waiter (server solicitation) to collect the portion from the Chef.
     */
    ...
    /**
     *  Used by Waiter (server solicitation) to verify if all portions of the current course have been delivered to the Students.
     * 
